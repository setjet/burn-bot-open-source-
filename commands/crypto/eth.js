...
module.exports = {
  ...
  async execute(message, args, { prefix }) {
    ...
    if (subcommand === 'set') {
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription([
                ...
                '',
                `-# Use \`${prefix}eth set <address>\` to set your Ethereum wallet address.`
              ].join('\n'))
          ],
          allowedMentions: { repliedUser: false }
        });
      ...
      const nonce = dbHelpers.createVerificationNonce(userId, currency, address, 10); // 10 minute expiry
