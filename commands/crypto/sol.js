  ...
  async execute(message, args, { prefix }) {
    ...
    if (args.length === 0) {
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription([
                ...
                '',
                `-# Use \`${prefix}sol set <address>\` to set your wallet address.`
              ].join('\n'))
          ],
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields([
          { name: '', value: `-# Use \`${prefix}sol set <address>\` to update your wallet.`, inline: false }
        ]);
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription([
                ...
                '',
                `-# Use \`${prefix}sol set <address>\` to set your Solana wallet address.`
              ].join('\n'))
          ],
          allowedMentions: { repliedUser: false }
        });
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription([
                ...
                '',
                `> You don't have a Solana wallet address set.`,
                '',
                `-# Use \`${prefix}sol set <address>\` to set your wallet first.`
              ].join('\n'))
          ],
          allowedMentions: { repliedUser: false }
        });
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription([
                ...
                '',
                `> Your Solana wallet is already verified.`
              ].join('\n'))
          ],
          allowedMentions: { repliedUser: false }
        });
        ...
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription([
              ...
              '',
              `> Your Solana wallet address has been removed.`
            ].join('\n'))
        ],
        allowedMentions: { repliedUser: false }
      });
      ...
      embeds: [
        new EmbedBuilder()
          ...
          .setDescription([
            ...
            '',
            `-# Available commands:`,
            `> \`${prefix}sol\` - View your wallet`,
            `> \`${prefix}sol set <address>\` - Set your wallet address`,
            `> \`${prefix}sol verify <signature>\` - Verify wallet ownership`,
            `> \`${prefix}sol remove\` - Remove your wallet address`
          ].join('\n'))
      ],
      allowedMentions: { repliedUser: false }
    });
