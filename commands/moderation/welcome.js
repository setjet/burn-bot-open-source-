  ...
  async execute(message, args, { prefix }) {
    ...
    if (subcommand === 'set') {
          ...
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription([
                ...
                '',
                `**Example:** \`${prefix}dm set join backup discord.gg/example\``,
                '',
                '**Aliases:** `N/A`'
              ].join('\n'))
          ],
      ...
      const successEmbed = new EmbedBuilder()
        .setColor('#838996')
        .setDescription('<:check:1457808518848581858> <:arrows:1457808531678957784> DM message has been **set**.\n-# <:tree:1457808523986731008> **Message:** ' + messageText)
        ...
        await message.author.send({ 
          ...
          return message.reply({
            embeds: [
              new EmbedBuilder()
                .setColor('#838996')
                .setDescription('<:disallowed:1457808577786806375> <:arrows:1457808531678957784> I couldn\'t send you a DMs.\n-# <:tree:1457808523986731008> Please make sure your **DMs are enabled**.')
            ],
            allowedMentions: { repliedUser: false }
          });
        });
